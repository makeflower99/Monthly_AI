...
function loadQuestion(index) {
    ...
    const apiUrl = `http://${window.location.hostname}:8000/api/questions/Difficulty/realtime/data?difficulty=${difficulty}&article_code=${articleCode}&index=${index}`; // 동적으로 호스트 이름을 사용하여 URL 생성
